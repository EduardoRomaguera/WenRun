...
public class ListarDistritoController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            gestorDistrito.listarDistritos().forEach(distrito -> datos.addAll(distrito));
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        col3.setCellValueFactory(new PropertyValueFactory<>("nombreCanton"));
